...
function Main() {
  return (
    <div className='bg-neutral-100 w-[90%] h-[85%] rounded-lg shadow-md flex overflow-hidden'>
        ...
        {/* second column */}
        <div className='w-1/3 bg-neutral-200 p-4 flex flex-col'>
            <div className='h-3/5'>
                <div className='flex items-center justify-center h-14'>
                    <img src="claimate-logo.webp" className='w-12' alt="Claimate logo" />
                    <p>claimate</p>
                </div>
